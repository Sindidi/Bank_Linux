...
tput cup 3 0; echo "|---------------------------------------------------------------------------------------------------------------------------------|"
sleep 0.15
tput cup 4 0; echo "|						RAPPORT POUR TOUS LES COMPTES TRIER PAR Id                                        |"
sleep 0.15
tput cup 5 0; echo "|---------------------------------------------------------------------------------------------------------------------------------|"
sleep 0.15
...
sort -t ":" -k1 doc.txt > rapport_id.txt
sleep 0.15
l=8
while read line;
do
sleep 0.15
tput cup $l; echo "|\e[1;32m `echo $line | cut -d":" -f1`\e[0m"
sleep 0.15
...
sleep 0.15
tput cup $l 94; echo "| `echo $line | cut -d":" -f7`"
sleep 0.15
...
sleep 0.15
echo " "
echo "Voilà la liste de tous les comptes, trier par les Id"
